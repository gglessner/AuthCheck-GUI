# Opengear Console Server Authentication Module
...
module_description = "Opengear Console Server (Console)"
...
form_fields = [
    ...
    {"name": "hints", "type": "readonly", "label": "Hints", "default": "root / default (default). HTTPS: 443, SSH: 22"},
]


def authenticate(form_data):
    """
    Attempt to authenticate to Opengear Console Server.
    """
    try:
        import requests
    except ImportError:
    ...
    try:
        ...
        # Opengear API login
        login_url = f"{base_url}/api/v1/sessions"
        ...
        if response.status_code == 200 or response.status_code == 201:
            ...
            if data.get("token") or data.get("session"):
                # Get system info
                info_url = f"{base_url}/api/v1/system"
                ...
                if info_resp.status_code == 200:
                    ...
                    model = info_data.get("model", "Opengear")
        ...
        return False, f"Opengear error: {e}"
