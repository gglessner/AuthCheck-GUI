# ATEN KVM Authentication Module
...
module_description = "ATEN KVM (KVM)"
...
form_fields = [
    ...
    {"name": "hints", "type": "readonly", "label": "Hints", "default": "administrator / password (default). HTTPS: 443"},
]


def authenticate(form_data):
    """
    Attempt to authenticate to ATEN KVM switches.
    """
    try:
        import requests
    except ImportError:
    ...
    try:
        ...
        if response.status_code == 200:
            if "SESSIONID" in response.cookies or "logout" in response.text.lower():
                import re
        ...
        return False, f"ATEN KVM error: {e}"
